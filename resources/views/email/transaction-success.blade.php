                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img alt="" height="auto" src="{{url('frontend/images/logo_nomads@2x.png')}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                              ...
                              <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4d;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                ...
                                <tr>
                                  <td><strong>{{$item->username}}</strong></td>
                                    <td style="text-align:right;">{{$item->nationally}}</td>
                                </tr>
                                @endforeach
                              </table>
                            </td>
                          ...
                          <tr>
                            <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                <tr>
                                  <td align="center" bgcolor="#ff9e53" role="presentation" style="border:none;border-radius:6px;cursor:auto;background:#ff9e53;" valign="middle">
                                  <a href="{{url('checkout/'. $data->id )}}" style="display:inline-block;background:#ff9e53;color:#ffffff;font-family:Assistant,Helvitica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;border-radius:6px;"> Check Detail </a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                        <tr>
                          <td style="width: 50px">
                            <img src="{{url('frontend/images/icon/drawable-mdpi/group 13.png')}}">
                          </td>
                          <td style="font-size: 18px; padding-left: 10px; color: #071c4d; font-family:Assistant, Helvetica, Arial, sans-serif"> Support@nomads.id <br> 021-2019-2020 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
